...
digitalWrite(key, val);
 ...
 if (DHT.humidity<32.00)
  {
 // digitalWrite(led, LOW);    // turn the LED off by making the voltage LOW

  }
   
   if (DHT.humidity>35.00)
  {
...
//char strtime[30];
//int time1 = 1200;
//sprintf(strtime, "%u", time1);
         //  day,
         //  t.yr, t.mon, t.date,
         //  t.hr, t.min, t.sec);
// LcdString("H:");
//   char strrrrr[11];
//   int number4 = Altitude/100;
//    sprintf(strrrrr, "%u", number4);
//    LcdString(strrrrr);
//    LcdString("M");
//     gotoXY(0,3);
//     LcdString("------------");  
...
char strkey[11];
 //  int number0 = DHT.humidity;
    int number14 = key;
    sprintf(strkey, "%u", number14);
    LcdString(strkey);
  ...
  LcdString("VAL:");  
   ...
   char strval[11];
  // int number1 = DHT.temperature;
     int number112 = val;
    sprintf(strval, "%u", number112);
    LcdString(strval);
    LcdString("");
//---------------------------------------
